...
static int injectPipes[MAX_INJECTS]; // injectPipes[injId] = 1 if pipe exists, 0 if it doesn't

// The connectionDests array keeps track of what nodes are listening to the output of the "from" node
